...
class ConfigService {
    private:
        ...
        void savePreference(const char *key, String& setting);
        void savePreference(const char *key, bool& setting);
        void savePreference(const char *key, uint& setting);
        void savePreference(const char *key, uint8_t& setting);
        template<typename SettingType>
        void saveEnumPreference(const char *key, SettingType& setting);
        void saveBlobPreference(const char *key, String& setting);
    public:
